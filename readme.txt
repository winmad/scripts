...
./distribute_data.sh <tar file> <data parent directory> <#slave nodes>
./distribute_data.sh bunny.tar.gz /mnt/ 9

./run_mtssrv.sh <data directory> <#slave nodes>
./run_mtssrv.sh /mnt/bunny 9

./init.sh <data tar file> <data parent directory> <data directory> <#slave nodes>
./init.sh bunny.tar.gz /mnt/ /mnt/bunny 9
